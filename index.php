...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php"><span>Home</span></a></h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Tela de cadastro simples com php + mysql e bootstrap</h1>
            <div class="text-center text-lg-start">
              <a href="create.php" class="btn-get-started scrollto">Cadastrar</a>
              <a href="show.php" class="btn-get-started scrollto">Listar</a>
            </div>
          </div>
        </div>
